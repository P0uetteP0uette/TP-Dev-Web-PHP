    ...
    <main class="main-content">
        ...
        <div class="container-narrow">
            ...
            <div class="page-header-simple">
                <a href="projects.php" class="link-back">← Annuler et retour</a>
                <h1>Créer un nouveau projet</h1>
                <p>Définissez le cadre contractuel et l'équipe assignée.</p>
            </div>

            <div class="card">
                <form action="projects.php" method="POST" id="createProjectForm">
                    ...
                    <div class="d-flex gap-1 mb-1 mobile-col">
                        <div class="form-group flex-2">
                            ...
                            <input type="text" id="name" name="nom" placeholder="Ex: Refonte Site E-commerce" required>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="description" name="description" rows="3" placeholder="Décrivez les objectifs principaux du projet..."></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="d-flex gap-1 flex-wrap">
                            <label class="checkbox-pill">
                                <input type="checkbox" name="team[]" value="Alice L." checked> Alice L. (Lead Dev)
                            </label>

                            <label class="checkbox-pill">
                                <input type="checkbox" name="team[]" value="Jean P."> Jean P. (Frontend)
                            </label>

                            <label class="checkbox-pill">
                                <input type="checkbox" name="team[]" value="Sophie M."> Sophie M. (Backend)
                            </label>
